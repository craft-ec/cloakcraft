      ...
      if (decrypted) {
        ...
        if (Buffer.from(commitment).toString("hex") === entry.commitment) {
          const note = {
            ...
            pool: new PublicKey2(entry.pool)
          };
...
var PROGRAM_ID = new PublicKey4("fBh7FvBZpex64Qp7i45yuyxh7sH8YstYyxGLmToLRTP");
var SEEDS = {
...
var DEVNET_V2_TREES = {
  STATE_TREE: new PublicKey4("bmt1LryLZUMmF7ZtqESaw7wifBXLfXHQYoE4GAmrahU"),
  OUTPUT_QUEUE: new PublicKey4("oq1na8gojfdUhsfCpyjNt6h4JaDWtHf1yQj4koBWfto"),
  ADDRESS_TREE: new PublicKey4("amt2kaJA14v3urZbZvnc5v2np8jqvc4Z8zDep5wbtzx")
};
var CIRCUIT_IDS = {
...
import {
  createRpc as createRpc2,
  bn as bn2,
  deriveAddressSeedV2 as deriveAddressSeedV22,
  deriveAddressV2 as deriveAddressV22,
  PackedAccounts,
...
var LightProtocol = class {
  constructor(rpcUrl, programId = PROGRAM_ID) {
    this.rpc = createRpc2(rpcUrl, rpcUrl);
  ...
  deriveCommitmentAddress(pool, commitment) {
    ...
    const addressSeed = deriveAddressSeedV22(seeds);
    return deriveAddressV22(addressSeed, addressTreeInfo.tree, this.programId);
  }
  /**
  ...
  async getCombinedValidityProof(commitmentAccountHash, nullifierAddress) {
    const addressTreeInfo = this.getAddressTreeInfo();
    const hashBytes = new PublicKey5(commitmentAccountHash).toBytes();
    return this.rpc.getValidityProofV0(
      ...
      [{
        address: bn2(nullifierAddress.toBytes()),
        tree: addressTreeInfo.tree,
        queue: addressTreeInfo.queue
      }]
    );
