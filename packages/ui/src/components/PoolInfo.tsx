      ...
      <div style={styles.stack}>
        ...
        <div style={{ display: 'grid', gap: '12px' }}>
          ...
          <InfoRow
            ...
            value={pool?.nextLeafIndex?.toString() ?? '0'}
          />
          <InfoRow
            label="Root Index"
            value={pool?.rootIndex?.toString() ?? '0'}
          />
        </div>
        ...
        {pool?.merkleRoot && (
          <div style={{
            ...
            <div style={{ color: colors.textMuted, marginBottom: '4px' }}>Current Merkle Root</div>
            <div style={{ ...styles.mono, wordBreak: 'break-all', color: colors.text }}>
              {Buffer.from(pool.merkleRoot).toString('hex').slice(0, 32)}...
            </div>
          </div>
        )}
      </div>
